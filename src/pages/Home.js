...
function Home({ persona }) {
  ...
  // Dynamic Text
  const heroTitle = isWebDev ? "Web Developer" : "Data Analyst";
    ...
    <div className="home-container">
      ...
      <section id="home" className="hero-section">
        <div className="hero-content">
          ...
          {/* --- NEW: Animated Interactive Hero Title --- */}
          <h1 className="hero-title interactive-word">
            {heroTitle.split('').map((char, index) => (
              <span key={index} className="char">
                {/* We must render non-breaking spaces for empty spaces */}
                {char === ' ' ? '\u00A0' : char}
              </span>
            ))}
          </h1>
      ...
      {/* Other Sections */}
      <section id="about"><About persona={persona} /></section>
      <section id="academic"><Academic /></section>
      <section id="project"><Project persona={persona} /></section>
